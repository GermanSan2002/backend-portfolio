...
import { Proyect } from 'src/modules/proyects/entity/proyect.entity';
import { Education } from 'src/modules/education/entity/education.entity';
...
export const DataSourceConfig: DataSourceOptions = {
  ...
  entities: [User, Operation, Experience, Skills, Proyect, Education],
  synchronize: true,
};
